...
#define U8TO32_LITTLE(p)	htole32(((const uint32_t*)(const void *)(p))[0])
#define U32TO8_LITTLE(p, v)	(((uint32_t*)(void *)(p))[0] = le32toh(v))
#else
...
void
salsa20_crypt(salsa20_ctx *x, const uint8_t *m, uint8_t *c, u_int bytes)
{
